				...
				<div id="inner-content" class="wrap cf">
					...
					<div id="main" class="m-all t-2of3 d-5of7 cf" role="main">
						...
						<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
							...
							<div class="tag-links">
								<?php
									$category_list = get_the_category_list( __( ', ', 'travel-notes' ) );
									printf( __('Filed under: %s', 'travel-notes'),
									$category_list
									);
								?>
							</div>
							<?php if(has_tag()): ?>
							    <div class="tag-links">
							      <div class="clear"></div>
							      <?php esc_html_e('Tags: ','travel-notes'); ?>
							      <?php echo get_the_tag_list('',',','');?>
							    </div>
							 <?php endif; ?>

							<footer class="below-content-area">
								<?php if ( get_theme_mod('travel_notes_author_area') ):
		                    	...
		                    	<?php if ( get_theme_mod('travel_notes_related_posts') ):
			                    ...
			                    <div class="related-posts <?php echo esc_attr( $related_class ); ?>">
				                    <h3 class="section-title"><?php esc_html_e('You may also like ','travel-notes'); ?></h3>
				                    <div> 
					                            ...
					                            <div class="related-item">
					                              <div class="related-image">
						                              <a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title_attribute(); ?>">
						                                <?php $image_thumb = travel_notes_catch_that_image_thumb(); $gallery_thumb = travel_notes_catch_gallery_image_thumb(); 
						...
						<?php else : ?>
							...
							<article id="post-not-found" class="hentry cf">
									<header class="article-header">
										<h1><?php esc_html_e( 'Oops, Post Not Found!', 'travel-notes' ); ?></h1>
										<p><?php esc_html_e( 'Uh Oh. Something is missing. Try double checking things.', 'travel-notes' ); ?></p>
									</header>
							</article>
