...
/* Social options */
	...
	$wp_customize->add_setting( 'weblizar_options_gl[scroll_btn]',
		array(
		'default'=>esc_attr($wl_theme_options['scroll_btn']),
		'type'=>'option',
		'sanitize_callback'=>'weblizar_gl_sanitize_checkbox',
		'capability'=>'edit_theme_options'
		)
	...
	$wp_customize->add_control( 'scroll_btn', array(
		'label'        => __( 'Enable/Disable Scroll Button', 'green-lantern' ),
		'type'=>'checkbox',
		'section'    => 'footer_section',
		'settings'   => 'weblizar_options_gl[scroll_btn]'
	) );
